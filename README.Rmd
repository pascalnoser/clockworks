...
Detecting rhythmic features using your method of choice is very straightforward. In the example below, we will use a synthetic data set of two rhythmic and eight non-rhythmic genes. We will analyse them using the [MetaCycle](https://github.com/gangwug/MetaCycle) implementation of the [JTK_CYCLE](https://doi.org/10.1177/0748730410379711) method:
