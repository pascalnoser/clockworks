...
cd_full <- add_experiment_info(cd_full, period = 24, data_type = "norm")
...
cd_rpl_rpt <- add_experiment_info(cd_rpl_rpt, period = 24, data_type = "norm")
...
cd_grp_rpt <- add_experiment_info(cd_grp_rpt, period = 24, data_type = "norm")
...
cd_rpt <- add_experiment_info(cd_rpt, period = 24, data_type = "norm")
...
cd_grp_rpl <- add_experiment_info(cd_grp_rpl, period = 24, data_type = "norm")
...
cd_rpl <- add_experiment_info(cd_rpl, period = 24, data_type = "norm")
...
cd_grp <- add_experiment_info(cd_grp, period = 24, data_type = "norm")
...
cd_min <- add_experiment_info(cd_min, period = 24, data_type = "norm")
